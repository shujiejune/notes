...
<<<<<<< HEAD
- compile-time interface verification: Go interfaces are implemented implicitly, use a `_` assignment global declaration to catch implementation errors at compile time.
=======
